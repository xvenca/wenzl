...
alt: "Pszczelarz przy ulach w Bergen"
layout: "birokt"
...
services:
  - icon: "swarm"
    title: "Łapanie rojów"
    badge: "Bezpłatnie"
    desc: "Widzisz rój na swojej posesji? Skontaktuj się ze mną od razu — bezpłatnie odławiam roje w Bergen i okolicy."
    link: "#swarm-collection-in-bergen"
  - icon: "trap"
    title: "Pułapki rojowe"
    badge: "Bezpłatnie · cała Norwegia"
    desc: "Chroń budynek przed rojami — ustawiam skrzynki wabikowe, które przechwytują rój, zanim osiedli się w kominie lub elewacji. Bezpłatnie w całej Norwegii."
    link: "#swarm-traps"
  - icon: "pollination"
    title: "Zapylanie"
    badge: "Pszczoły za miejsce"
    desc: "Na sezon bezpłatnie ustawiam swoje rodziny w twoim ogrodzie. Ty zapewniasz miejsce i kwiaty — pszczoły robią resztę."
...
## Usługa zapylania {#pollination-service}
...
Leżak na norweski rozmiar ramki z dwoma nadstawkami u góry do zimowego podziału rodziny. Nadstawki naturalnie ogrzewają się od rodziny poniżej — to delikatne dla pszczół w chłodnym sezonie.
...
### Norweski leżak o grubych ścianach
Mój własny projekt z wyjątkowo grubymi, izolującymi ścianami — na norweski rozmiar ramki. Może służyć zarówno jako funkcjonalny ul, jak i jako dekoracyjny obiekt do parków i przestrzeni publicznych. *(Żółty ul.)*

Zainteresowanie moimi ulami już się pojawia — *napisz do mnie w sprawie cen i terminów wykonania.*

## Miasta przyjazne pszczołom {#bee-friendly-cities}
...
Po wysłuchaniu wykładu **[doc. Ing. Antonína Přidala, Ph.D.](https://uchhz.af.mendelu.cz/lide-na-mendelu?osoba=3228)** o warrozie w Boskovicach skontaktowałem się z nim, by uczyć się pod jego kierunkiem. Ukończyłem kurs **[Pszczelarstwo i przetwarzanie produktów pszczelich](https://is.mendelu.cz/katalog/syllabus.pl?predmet=162023;lang=cz)** na **Uniwersytecie Mendla w Brnie**, gdzie doc. Přidal jest jednym z czołowych środkowoeuropejskich specjalistów od *Varroa destructor* i nauki o pszczelarstwie.
